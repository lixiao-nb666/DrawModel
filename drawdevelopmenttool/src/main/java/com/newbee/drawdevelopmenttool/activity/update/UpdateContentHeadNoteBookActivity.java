 ...
 */
public class UpdateContentHeadNoteBookActivity extends BaseCompatActivity {
    ...
    public int getViewLayoutRsId() {
        return R.layout.activity_update_content_note_book;
    }
    ...
    public void initData() {
        ...
        int defBgType=contentHeadBean.getBgType();
