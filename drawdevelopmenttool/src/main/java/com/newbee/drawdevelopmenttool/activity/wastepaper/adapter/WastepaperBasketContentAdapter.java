package com.newbee.drawdevelopmenttool.activity.wastepaper.adapter;
 ...
 */
public class WastepaperBasketContentAdapter extends RecyclerView.Adapter {
    ...
    public WastepaperBasketContentAdapter(Context context, List<ContentHeadBean> contentHeadBeanList, ItemClick itemClick) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHodler viewHodler = new ViewHodler(layoutInflater.inflate(R.layout.adapter_wastepaper_basket, parent, false));
        return viewHodler;
    }
...
//        String filePath=contentHeadBean.getLocalFilePath(1);
        ...
        MyGlide.getInstance().setBitMap(viewHodler.contentHeadCloseIV,rsId);
//        MyGlide.getInstance().setBitMapNoCache(context,viewHodler.contentHeadCloseIV,filePath,ImageView.ScaleType.CENTER);
